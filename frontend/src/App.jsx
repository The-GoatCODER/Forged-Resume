...
const API_URL = "http://127.0.0.1:5000/api/resume";
  ...
  return (
    <div style={{
      ...
      <div className="editor-panel" style={{
        ...
        <FloatInput label="Website / Portfolio" value={resume.basics.website} onChange={e => handleBasicsChange("website", e.target.value)} />
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "32px" }}>
              <div style={{
                ...
                justifyContent: "center",
                position: "relative",
                boxShadow: "0 0 0 8px rgba(201,168,76,0.06)"
              }}>
            ...
            <div style={{ marginBottom: "30px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                {[
                  ...
                  { icon: "⌘", val: resume.basics.website || "yourwebsite.com" },
                  ...
                  <div key={i} style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                    ...
                    <span style={{ fontSize: "12.5px", color: "#cde0dc", lineHeight: 1.5, wordBreak: "break-all" }}>{val}</span>
                  </div>
                ))}
              </div>
            </div>
                  ...
                  <div key={i} style={{ display: "grid", gridTemplateColumns: "18px 1fr", gap: "16px" }}>
                    ...
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", flexWrap: "wrap", gap: "4px", marginBottom: "4px" }}>
                        <h4 style={{ margin: 0, fontFamily: "'Cormorant Garamond', serif", fontSize: "18px", fontWeight: "700", color: "#111827" }}>
                          {work.company || "—"}
                        </h4>
                        <span style={{ fontSize: "11.5px", color: "#6b7280", letterSpacing: "0.02em" }}>{work.duration || "—"}</span>
                      </div>
                      <div style={{ fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase", color: "#c9a84c", fontWeight: "600", marginBottom: "8px" }}>
                        {work.role || "—"}
                      </div>
                      <p style={{ margin: 0, fontSize: "13.5px", lineHeight: "1.75", color: "#374151" }}>
                        {work.description || "—"}
                      </p>
                    </div>
                  </div>
            ...
            <Section title="Education" last>
              <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                {(resume.education.length > 0 ? resume.education : [
                  ...
                  <div key={i} style={{ display: "grid", gridTemplateColumns: "56px 1fr", gap: "16px", alignItems: "start" }}>
                    <div style={{
                      textAlign: "center",
                      ...
                      <span style={{ fontSize: "12px", fontWeight: "700", color: "#a87c2a", fontFamily: "'Cormorant Garamond', serif", display: "block", lineHeight: 1 }}>{edu.year || "—"}</span>
                    </div>
                    <div>
                      <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "17px", fontWeight: "700", color: "#111827", marginBottom: "3px" }}>{edu.institution || "—"}</div>
                      <div style={{ fontSize: "13px", color: "#4b5563", fontWeight: "400" }}>{edu.degree || "—"}</div>
                    </div>
                  </div>
                ))}
              </div>
